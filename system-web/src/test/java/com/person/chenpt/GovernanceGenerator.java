...
public class GovernanceGenerator {
	...
	public static void main(String[] args) {
		...
		String nextMoudleName = "system-web";
		String newprojectPath = projectPath+"/"+nextMoudleName;
		String moduleName = "re";
		FastAutoGenerator.create("jdbc:dm://test.jgj.ces:5236",  "EPIDEMIC-REPORT","Aa12345678")
				...
				.packageConfig(builder -> {
					builder.parent("com.person.chenpt.server.bus") // 设置父包名
							...
							.pathInfo(Collections.singletonMap(OutputFile.xml, newprojectPath+"/src/main/resources/mapper/"+moduleName)); // 设置mapperXml生成路径
				})
...
//							.addInclude("T_BILL_PAY_RENT")
							.addInclude("T_RE_NUCLEIC_ACID")
							.addInclude("T_RE_PEOPLE")
							.addTablePrefix("t_sys_", "t_re_"); // 设置过滤表前缀
